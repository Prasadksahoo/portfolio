    ...
    <div className=' bg-gray-800 h-screen overflow-x-hidden  '>
      ...
      <FaUserCircle size={40} /> 
        ...
        <div className=' hidden  font-bold ml-12 sm:flex space-x-4'>
          ...
          whileTap={{ scale: 0.95 }}
          className= 'bg-white hidden sm:block px-6 py-2 rounded-r-full rounded-l-full bg-linear-to-bl from-violet-500 to-fuchsia-500 text-amber-100'><a href="#contact" download='PRASAD_KUMAR_SAHOO_RESUME'>Get in Touch</a></motion.button>
      ...
      <a  className='bg-linear-to-bl from-violet-500 to-fuchsia-500 rounded-full' href="https://facebook.com/prince.prasad.902819/" target="_blank" rel="noopener noreferrer">
       ...
       <div  className=' my-4 flex flex-col -mx-3 justify-center    gap-4  sm:flex-row sm:gap-4 sm:justify-normal sm:mt-4 sm:-ml-2'>
         <motion.button  whileHover={{ opacity: 0.8}}
          whileTap={{ scale: 0.95 }}  className='bg-linear-to-bl from-violet-500 to-fuchsia-500 px-6 py-2 mx-1.5 rounded-r-full rounded-l-full flex justify-center items-center '><a href="resume.pdf" download='PRASAD_KUMAR_SAHOO_RESUME'>DOWNLOAD CV</a></motion.button>
        <motion.button  whileHover={{ opacity: 0.8}}
